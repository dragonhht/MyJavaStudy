 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://ws.dragonhht.github.com/", wsdlLocation = "http://localhost:8081/web/sayHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://ws.dragonhht.github.com/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/web/sayHello?wsdl");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://ws.dragonhht.github.com/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.dragonhht.github.com/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
